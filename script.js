...
function kirillToLatin(inputText) {
  ...
  outText = outText.replace(/ў/g, "o'"); //tarjima qilinmagan harflarni kirilchaga o'tkazadi
  ...
  outText = outText.replace(/Ғ/g, "G'");
  outText = outText.replace(/с/g, "c"); //tarjima qilinmagan bittalik harlarni kirillchaga o'giradi
...
const downbutton = document.getElementById("downb-c");
const menuModal = document.getElementById("menu-modal");
const menuModalBack = document.getElementById("menu-modal-back");
var focused = inputText;
function translatetokirill() {
  outputText.value = latinToKirill(inputText.value);
}
function translatetolatin() {
  inputText.value = kirillToLatin(outputText.value);
}
...
function activateanim() {
  if (menuModal.style.top == "-200%") {
    menuModal.style.top = "0px";

    menuModal.style.animationName = "modalanimation";
    menuModalBack.style.animationName = "show-menu-modal-back";
    menuModalBack.style.zIndex = "1";
    menuModalBack.style.opacity = "0.75";
    menuModalBack.style.animationDuration = "500ms";
    menuModal.style.animationDuration = "500ms";
  } else {
    menuModal.style.top = "-200%";
    setTimeout(() => {
      menuModalBack.style.zIndex = "-1";
    }, 499);
    menuModalBack.style.animationName = "hide-menu-modal-back";
    menuModalBack.style.opacity = "0";
    menuModalBack.style.animationDuration = "500ms";
    menuModal.style.animationName = "hide-menu-modal";
    menuModal.style.animationDuration = "500ms";
  }
}
inputText.addEventListener("keyup", translatetokirill);
...
outputText.addEventListener("keyup", translatetolatin);
downbutton.addEventListener("click", activateanim);
